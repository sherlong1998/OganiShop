    ...
    return (
        <div className={cx('wrapper', 'col', 'l-9')}>
            <div className={cx('shop_content')}>
                ...
                <div className={cx('shop_content_filter','row',c)}>
                    <div className={cx('shop_content_filter_sort')}>

                    </div>
                    <div className={cx('shop_content_filter_found')}>

                    </div>
                    <div className={cx('shop_content_filter_option')}>
