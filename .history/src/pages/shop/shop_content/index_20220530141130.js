    ...
    return (
        <div className={cx('product_discount_content_items_item', 'l-4', 'col')}>
            ...
            <div className={cx('item_text')}>
                ...
                <div className={cx('item_text_price')}>{props.discountPrice}<span>{props.price}</span></div>
            </div>
        </div>
    );
}
            ...
            <div className={cx('shop_content')}>
                <div className={cx('shop_content_product_discount')}>
                    ...
                    <div className={cx('product_discount_content')}>
                        ...
                        <PostItem image={imageShopItem} title="image featured" kindItem="Dried Fruit" nameItem="Vegetable's Packet" discountPrice="30.00" price="$36.00" />
                        </div>
