...
function HeaderBot() {
    return (
        <div className={`${styles.header_bot} grid wipe row`}>
            ...
            <div className={`${styles.hero_search} l-9 m-9 col`}>
                <div className={`${styles.hero_search__top}`}>
                    <div className={`${styles.hero_search__top_} l-8 m-8 col`}>
                    ...
                    <div className={`${styles.hero_search__top__contact} l-4 m-4 col`}>
