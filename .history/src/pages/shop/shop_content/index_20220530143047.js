    ...
    return (
        <div className={cx('wrapper', 'col', 'l-9')}>
            <div className={cx('shop_content')}>
                ...
                <PostItem image={imageShopItem} title="image featured" desc="Crab Pool Security" price="$30.00<PostItem image={imageShopItem} title="image featured" desc="Crab Pool Security" price="$30.00" />
                </div>
